...
namespace XCoin.SmartContract
{
    public class StateReader : InteropService, IDisposable
    {
        ...
        public StateReader()
        {
            Register("XCoin.Runtime.GetTrigger", Runtime_GetTrigger);
            Register("XCoin.Runtime.CheckWitness", Runtime_CheckWitness);
            Register("XCoin.Runtime.Notify", Runtime_Notify);
            Register("XCoin.Runtime.Log", Runtime_Log);
            Register("XCoin.Runtime.GetTime", Runtime_GetTime);
            Register("XCoin.Runtime.Serialize", Runtime_Serialize);
            Register("XCoin.Runtime.Deserialize", Runtime_Deserialize);
            Register("XCoin.Blockchain.GetHeight", Blockchain_GetHeight);
            Register("XCoin.Blockchain.GetHeader", Blockchain_GetHeader);
            Register("XCoin.Blockchain.GetBlock", Blockchain_GetBlock);
            Register("XCoin.Blockchain.GetTransaction", Blockchain_GetTransaction);
            Register("XCoin.Blockchain.GetAccount", Blockchain_GetAccount);
            Register("XCoin.Blockchain.GetValidators", Blockchain_GetValidators);
            Register("XCoin.Blockchain.GetAsset", Blockchain_GetAsset);
            Register("XCoin.Blockchain.GetContract", Blockchain_GetContract);
            Register("XCoin.Header.GetIndex", Header_GetIndex);
            Register("XCoin.Header.GetHash", Header_GetHash);
            Register("XCoin.Header.GetVersion", Header_GetVersion);
            Register("XCoin.Header.GetPrevHash", Header_GetPrevHash);
            Register("XCoin.Header.GetMerkleRoot", Header_GetMerkleRoot);
            Register("XCoin.Header.GetTimestamp", Header_GetTimestamp);
            Register("XCoin.Header.GetConsensusData", Header_GetConsensusData);
            Register("XCoin.Header.GetNextConsensus", Header_GetNextConsensus);
            Register("XCoin.Block.GetTransactionCount", Block_GetTransactionCount);
            Register("XCoin.Block.GetTransactions", Block_GetTransactions);
            Register("XCoin.Block.GetTransaction", Block_GetTransaction);
            Register("XCoin.Transaction.GetHash", Transaction_GetHash);
            Register("XCoin.Transaction.GetType", Transaction_GetType);
            Register("XCoin.Transaction.GetAttributes", Transaction_GetAttributes);
            Register("XCoin.Transaction.GetInputs", Transaction_GetInputs);
            Register("XCoin.Transaction.GetOutputs", Transaction_GetOutputs);
            Register("XCoin.Transaction.GetReferences", Transaction_GetReferences);
            Register("XCoin.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins);
            Register("XCoin.InvocationTransaction.GetScript", InvocationTransaction_GetScript);
            Register("XCoin.Attribute.GetUsage", Attribute_GetUsage);
            Register("XCoin.Attribute.GetData", Attribute_GetData);
            Register("XCoin.Input.GetHash", Input_GetHash);
            Register("XCoin.Input.GetIndex", Input_GetIndex);
            Register("XCoin.Output.GetAssetId", Output_GetAssetId);
            Register("XCoin.Output.GetValue", Output_GetValue);
            Register("XCoin.Output.GetScriptHash", Output_GetScriptHash);
            Register("XCoin.Account.GetScriptHash", Account_GetScriptHash);
            Register("XCoin.Account.GetVotes", Account_GetVotes);
            Register("XCoin.Account.GetBalance", Account_GetBalance);
            Register("XCoin.Asset.GetAssetId", Asset_GetAssetId);
            Register("XCoin.Asset.GetAssetType", Asset_GetAssetType);
            Register("XCoin.Asset.GetAmount", Asset_GetAmount);
            Register("XCoin.Asset.GetAvailable", Asset_GetAvailable);
            Register("XCoin.Asset.GetPrecision", Asset_GetPrecision);
            Register("XCoin.Asset.GetOwner", Asset_GetOwner);
            Register("XCoin.Asset.GetAdmin", Asset_GetAdmin);
            Register("XCoin.Asset.GetIssuer", Asset_GetIssuer);
            Register("XCoin.Contract.GetScript", Contract_GetScript);
            Register("XCoin.Storage.GetContext", Storage_GetContext);
            Register("XCoin.Storage.Get", Storage_Get);
            Register("XCoin.Storage.Find", Storage_Find);
            Register("XCoin.Iterator.Next", Iterator_Next);
            Register("XCoin.Iterator.Key", Iterator_Key);
            Register("XCoin.Iterator.Value", Iterator_Value);
